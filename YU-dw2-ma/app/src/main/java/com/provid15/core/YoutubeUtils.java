...
import com.provid15.core.entity.FmtStreamMap;
import com.provid15.core.entity.Resolution;
import com.provid15.utils.LogUtil;
...
public class YoutubeUtils {
    ...
    static {
        ...
        Resolutions.put("139", new Resolution("139", "Audio only", "mp3", "normal", ResolutionNote.MHD));
        Resolutions.put("140", new Resolution("140", "Audio only", "mp3", "normal", ResolutionNote.MHD));
        Resolutions.put("141", new Resolution("141", "Audio only", "mp3", "normal", ResolutionNote.MHD));
...
/*
        Resolutions.put("171", new Resolution("313", "Audio only", "mp3", "normal", ResolutionNote.MHD));
        Resolutions.put("172", new Resolution("313", "Audio only", "mp3", "normal", ResolutionNote.MHD));*/
    }
